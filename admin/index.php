...
<?php
                ...
                ?>
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"><a class="btn btn-info" href="tambah.php?nama_halaman=Menambah Sepatu">
                    ...
                    if (mysqli_num_rows($query) > 0) {
                        while ($data = mysqli_fetch_array($query)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit.php?id=<?php echo $data["id"] ?>" class="badge text-bg-warning "> Ubah </a>&nbsp;
                                    <a href="proses_hapus.php?id=<?php echo $data["id"] ?>" class="badge text-bg-danger">Delete
                                    </a>
                                </td>
                            </tr>
                        <?php } ?>
